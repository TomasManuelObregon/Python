...
path = os.path.expanduser("~/Desktop/NewFolder2")    # Ruta a la carpeta de los datos

c_texto='#2D2A21'
colores = ["#6D4C41", "#A0522D", "#D2691E", "#FF4500", 'green'][::-1]   # para el folder 2
# colores = ["#6D4C41", "#A0522D", "#D2691E", "#FF4500"][::-1]          # para el folder 3 
...
archivos, archivos_txt = archivos[::-1], archivos_txt[::-1]  # Seleccionar archivos e invertir el orden 
...
for idx in range(len(archivos)):
    ...
    if idx ==2:
        ...
        axs[idx, 1].set_ylabel('Amplitud [mV]', fontsize=25, fontproperties=font_prop)
    ...
    if idx ==4:
        ...
        axs[idx, 2].set_xlabel('Frecuencia [Hz]', fontsize=25, fontproperties=font_prop)
...
plt.savefig('/Users/tomas/Desktop/señales_y_espectros_canalZ.png', bbox_inches='tight')    
